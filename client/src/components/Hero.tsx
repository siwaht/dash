    ...
    <section ref={sectionRef} id="hero" aria-label="Hero section" className="py-12 sm:py-16 md:py-24 lg:py-32 text-center bg-light-secondary dark:bg-dark-primary transition-colors relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="scroll-reveal text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.35] mb-6 sm:mb-7 md:mb-8 tracking-tight" style={{ animationDelay: '0.1s' }}>
          ...
          <p className="scroll-reveal text-base sm:text-lg md:text-xl text-text-light-secondary dark:text-text-dark-secondary max-w-3xl mx-auto mb-6 sm:mb-7 md:mb-8 leading-relaxed font-medium" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="scroll-reveal flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-10 sm:mb-12 md:mb-16" style={{ animationDelay: '0.3s' }}>
            <a
              href="#demo-form"
          ...
          <div className="scroll-reveal grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 md:gap-6 max-w-4xl mx-auto mb-10 sm:mb-12 md:mb-16" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center justify-center sm:justify-start gap-3 sm:gap-4 bg-light-primary/95 dark:bg-dark-secondary/95 p-5 md:p-6 rounded-2xl border border-brand-slate-light/30 dark:border-brand-slate/30 shadow-elevation-1 transition-all duration-300 hover:shadow-elevation-2" aria-label="24/7 Availability">
              <Clock className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-brand-blue-mid flex-shrink-0" aria-hidden="true" />
            ...
            <div className="flex items-center justify-center sm:justify-start gap-3 sm:gap-4 bg-light-primary/95 dark:bg-dark-secondary/95 p-5 md:p-6 rounded-2xl border border-brand-slate-light/30 dark:border-brand-slate/30 shadow-elevation-1 transition-all duration-300 hover:shadow-elevation-2" aria-label="10x Efficiency Boost">
              <Bot className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-brand-emerald-mid flex-shrink-0" aria-hidden="true" />
              <div className="text-left flex-1">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-3 sm:gap-4 bg-light-primary/95 dark:bg-dark-secondary/95 p-5 md:p-6 rounded-2xl border border-brand-slate-light/30 dark:border-brand-slate/30 shadow-elevation-1 transition-all duration-300 hover:shadow-elevation-2" aria-label="70% Cost Reduction">
              <TrendingDown className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-brand-teal-mid flex-shrink-0" aria-hidden="true" />
              <div className="text-left flex-1">

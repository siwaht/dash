              ...
              <div className="flex-1 flex items-end justify-between gap-1">
                {[65, 45, 80, 60, 90, 70].map((height, i) => (
                  <div key={i} className="flex-1 bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t"
                    style={{
                      height: `${height}%`,
                      animation: `grow-bar 0.6s ease-out ${2.6 + i * 0.1}s both`
                    }}
                  ></div>
                ))}
              </div>
            ...
            >
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full" style={{
                  ...
                  animation: 'spin-in 1s ease-out 2.8s both'
                }}>
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        left: `${pin.x}%`,
                        top: `${pin.y}%`,
                        animation: `pin-drop 0.5s ease-out ${3.2 + i * 0.1}s both`
                      }}
                    >
                ...
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 50" preserveAspectRatio="none">
                  <polyline
                    ...
                    style={{
                      ...
                      animation: 'draw-line 1.5s ease-out 3.4s forwards'
                    }}
                  />
                  <defs>
